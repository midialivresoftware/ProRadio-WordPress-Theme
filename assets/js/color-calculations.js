 ...
 * @return {Object} - this
 */
function _RadioProColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_RadioProColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_RadioProColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_RadioProColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _RadioProColor object.
 *
 * @since RadioPro 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function RadioProColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _RadioProColor( backgroundColor, accentHue );
